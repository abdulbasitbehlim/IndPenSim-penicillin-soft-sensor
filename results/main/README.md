...
| File | Purpose |
|---|---|
| [cross_validated_overall_metrics.csv](cross_validated_overall_metrics.csv) | Pooled MAE, RMSE and R² for normal-only and fault-inclusive HGB on normal and fault batches. |
